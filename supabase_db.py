...
def map_account_for_frontend(account: dict):
    ...
    linkedin = account.get("linkedin") or ""
    linkedin_clean = linkedin.replace("https://www.linkedin.com/company/", "").replace(
    ...
    return {
        ...
        "icon": account.get("icon") or ((account.get("company_name") or "A")[:1].upper()),
